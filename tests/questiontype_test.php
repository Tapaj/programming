...
/**
 * Unit tests for the programming question type class.
 *
 * @package    qtype
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_programming_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_programming();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'programming');
    }
