...
/**
 * This file contains tests that walks programming questions through some attempts.
 *
...
/**
 * Unit tests for the programming question type.
 *
 * @copyright 2013 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_programming_walkthrough_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_html_editor() {
        ...
        // Create an programming question.
        $q = test_question_maker::make_question('programming', 'editor');
    ...
    public function test_deferred_feedback_plain_text() {
        ...
        // Create an programming question.
        $q = test_question_maker::make_question('programming', 'plain');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_responsetemplate() {
        ...
        // Create an programming question.
        $q = test_question_maker::make_question('programming', 'responsetemplate');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_deferred_feedback_html_editor_with_files_attempt_on_last() {
        ...
        // Create an programming question in the DB.
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('programming', 'editorfilepicker', array('category' => $cat->id));
    ...
    public function test_deferred_feedback_plain_attempt_on_last() {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('programming', 'plain', array('category' => $cat->id));
