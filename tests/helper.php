...
/**
 * Test helpers for the programming question type.
 *
...
/**
 * Test helper class for the programming question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_programming_test_helper extends question_test_helper {
     ...
     */
    protected function initialise_programming_question() {
        question_bank::load_question_definition_classes('programming');
        $q = new qtype_programming_question();
        test_question_maker::initialise_a_question($q);
        $q->name = 'programming question (HTML editor)';
        ...
        $q->qtype = question_bank::get_qtype('programming');

        return $q;
    }

    /**
     * Makes an programming question using the HTML editor as input.
     * @return qtype_programming_question
     */
    public function make_programming_question_editor() {
        return $this->initialise_programming_question();
    }

    /**
     * Make the data what would be received from the editing form for an programming
     ...
     */
    public function get_programming_question_form_data_editor() {
        $fromform = new stdClass();

        $fromform->name = 'programming question (HTML editor)';
    ...
    /**
     * Makes an programming question using the HTML editor allowing embedded files as
     * input, and up to three attachments.
     * @return qtype_programming_question
     */
    public function make_programming_question_editorfilepicker() {
        $q = $this->initialise_programming_question();
     ...
     * @return qtype_programming_question
     */
    public function make_programming_question_editorfilepickertworequired() {
        $q = $this->initialise_programming_question();
        $q->responseformat = 'editorfilepicker';
        $q->attachments = 2;
     ...
     * @return stdClass the data that would be returned by $form->get_gata();
     */
    public function get_programming_question_form_data_editorfilepicker() {
        $fromform = new stdClass();

        $fromform->name = 'programming question with filepicker and attachments';
        $fromform->questiontext = array('text' => 'Please write a story about a frog.', 'format' => FORMAT_HTML);
        $fromform->defaultmark = 1.0;
        $fromform->generalfeedback = array('text' => 'I hope your story had a beginning, a middle and an end.', 'format' => FORMAT_HTML);
    ...
    /**
     * Makes an programming question using plain text input.
     * @return qtype_programming_question
     */
    public function make_programming_question_plain() {
        $q = $this->initialise_programming_question();
     ...
     * @return stdClass the data that would be returned by $form->get_gata();
     */
    public function get_programming_question_form_data_plain() {
        $fromform = new stdClass();
    ...
    /**
     * Makes an programming question using monospaced input.
     * @return qtype_programming_question
     */
    public function make_programming_question_monospaced() {
        $q = $this->initialise_programming_question();
        $q->responseformat = 'monospaced';
        return $q;
    }

    public function make_programming_question_responsetemplate() {
        $q = $this->initialise_programming_question();
    ...
    /**
     * Makes an programming question without an online text editor.
     * @return qtype_programming_question
     */
    public function make_programming_question_noinline() {
        $q = $this->initialise_programming_question();
