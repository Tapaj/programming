<?php
/**
 * programming question renderer class.
 *
...
/**
 * Generates the output for programming questions.
 *
 * @copyright  NA
 * @license    NA
 */
class qtype_programming_renderer extends qtype_renderer {
    ...
    public function files_input(question_attempt $qa, $numallowed,
        ...
        if (!empty($qa->get_question()->filetypeslist)) {
            $text = html_writer::tag('p', get_string('acceptedfiletypes', 'qtype_programming'));
    ...
    public function manual_comment(question_attempt $qa, question_display_options $options) {
        ...
        return html_writer::nonempty_tag('div', $question->format_text(
                $question->graderinfo, $question->graderinfo, $qa, 'qtype_programming',
...
class qtype_programming_format_noinline_renderer extends plugin_renderer_base {
    ...
    protected function class_name() {
        return 'qtype_programming_noinline';
    }
...
class qtype_programming_format_editor_renderer extends plugin_renderer_base {
    protected function class_name() {
        return 'qtype_programming_editor';
    }

    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        return html_writer::tag('div', $this->prepare_response($name, $qa, $step, $context),
                ['class' => $this->class_name() . ' qtype_programming_response readonly',
    ...
    public function response_area_input($name, $qa, $step, $lines, $context) {
        ...
        $output .= html_writer::start_tag('div', array('class' =>
                $this->class_name() . ' qtype_programming_response'));
...
class qtype_programming_format_editorfilepicker_renderer extends qtype_programming_format_editor_renderer {
    protected function class_name() {
        return 'qtype_programming_editorfilepicker';
    }
    ...
    protected function specific_filepicker_options($acceptedtypes, $draftitemid, $context) {
        debugging('qtype_programming_format_editorfilepicker_renderer::specific_filepicker_options() is deprecated, ' .
...
class qtype_programming_format_plain_renderer extends plugin_renderer_base {
    ...
    protected function textarea($response, $lines, $attributes) {
        $attributes['class'] = $this->class_name() . ' qtype_programming_response';
    ...
    protected function class_name() {
        return 'qtype_programming_plain';
    }
...
class qtype_programming_format_monospaced_renderer extends qtype_programming_format_plain_renderer {
    protected function class_name() {
        return 'qtype_programming_monospaced';
    }
}
