<?php
/**
 * programming question definition class.
 *
...
/**
 * Represents an programming question.
 *
 * @copyright  NA
 * @license    NA
 */
class qtype_programming_question extends question_with_responses {
     ...
     * @return qtype_programming_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_programming', 'format_' . $this->responseformat);
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_programming' && $filearea == 'graderinfo') {
