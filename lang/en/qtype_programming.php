<?php
/**
 * Strings for component 'qtype_programming', language 'en', branch 'MOODLE_39_STABLE'
 *
...
$string['pluginname_link'] = 'question/type/programming';
$string['pluginnameadding'] = 'Adding an programming question';
$string['pluginnameediting'] = 'Editing an programming question';
$string['pluginnamesummary'] = 'Allows a response of a file upload and/or online text. This must then be graded manually.';
$string['privacy:metadata'] = 'The programming question type plugin does not store any personal data.';
